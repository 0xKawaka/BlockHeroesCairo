...
trait BuffTrait {
    fn apply(self: Buff, ref caster: Entity, ref target: Entity);
    fn applyStatOrOther(self: Buff, ref entity: Entity, isStat: bool, isBonus: bool);
    fn getAoeEntities(self: Buff, ref caster: Entity, isBonus: bool) -> Array<Entity>;
