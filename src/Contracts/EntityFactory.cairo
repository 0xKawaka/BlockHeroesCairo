...
mod EntityFactory {
    ...
    impl InternalEntityFactoryImpl of InternalEntityFactoryTrait {
        ...
        fn initBaseStatisticsDict(ref self: ContractState) {
            self.baseStatistics.write('assassin', BaseStatistics::new(10, 200, 100, 185, 10, 100));
            self.baseStatistics.write('knight', BaseStatistics::new(10, 120, 180, 150, 10, 100));
            self.baseStatistics.write('priest', BaseStatistics::new(10, 150, 150, 160, 10, 100));
            self.baseStatistics.write('hunter', BaseStatistics::new(10, 170, 130, 170, 10, 200));
        }
