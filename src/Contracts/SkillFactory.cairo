...
use core::array::ArrayTrait;
    ...
    impl InternalSkillFactoryImpl of InternalSkillFactoryTrait {
        fn initSkills(ref self: ContractState) {
            ...
            self.skills.write('Fire Swing', SkillWithoutBuffs::new('Fire Swing', 3, Damage::new(200, true, false, false, Damage::DamageType::Flat), Skill::Heal::new(0, false, false, false, Heal::HealType::Percent), TargetType::Enemy, 1));
            ...
            self.skills.write('Water Shield', SkillWithoutBuffs::new('Water Shield', 4, Damage::new(0, false, false, false, Damage::DamageType::Flat), Skill::Heal::new(0, false, false, false, Heal::HealType::Percent), TargetType::Ally, 1));
            ...
            self.skills.write('Sandstorm', SkillWithoutBuffs::new('Sandstorm', 4, Damage::new(100, false, true, false, Damage::DamageType::Flat), Skill::Heal::new(0, false, false, false, Heal::HealType::Percent), TargetType::Enemy, 1));
        }
        fn initSkillsBuffs(ref self: ContractState) {
            ...
            FireStrikeBuffs.append(Buff::new(BuffType::Poison, 10, 2, true, false, false));
            let mut WaterHealBuffs = self.skillsBuffs.read('Water Heal');
            WaterHealBuffs.append(Buff::new(BuffType::Regen, 8, 2, false, true, false));
            let mut WaterShieldBuffs = self.skillsBuffs.read('Water Shield');
            WaterShieldBuffs.append(Buff::new(BuffType::DefenseUp, 80, 3, true, false, true));
            let mut ArrowsRainBuffs = self.skillsBuffs.read('Arrows Rain');
            ArrowsRainBuffs.append(Buff::new(BuffType::Poison, 10, 2, false, true, false));
            let mut ForestSensesBuffs = self.skillsBuffs.read('Forest Senses');
            ForestSensesBuffs.append(Buff::new(BuffType::AttackUp, 80, 2, false, false, true));
            ForestSensesBuffs.append(Buff::new(BuffType::SpeedUp, 80, 2, false, false, true));
